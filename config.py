...
FSUBS = [[-1004294321324, True, 10]] # Force Subscription Channels [channel_id, request_enabled, timer_in_minutes]
# Database Channel (Primary)
DB_CHANNEL = [-1004410404312]  # just put channel id dont add ""
# Multiple Database Channels (can be set via bot settings)
# DB_CHANNELS = {
#     "-1004410404312": {"name": "Primary DB", "is_primary": True, "is_active": True},
#     "-1004410404312": {"name": "Secondary DB", "is_primary": False, "is_active": True}
# }
# Auto Delete Timer (seconds)
AUTO_DEL = 300
# Admin IDs
ADMINS = [6558711318,6398757880]
# Bot Settings
DISABLE_BTN = True
PROTECT = True
